...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _newsAPI__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./newsAPI */ \"./newsAPI.js\");\n/* harmony import */ var _renderUI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderUI */ \"./renderUI.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.css */ \"./style.css\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_style_css__WEBPACK_IMPORTED_MODULE_2__);\n\n\n //Функция формирует и отправляет запрос на сервер\n\nfunction loadNews() {\n  var selectCountry = document.querySelector(\"#country\").value;\n  var selectCategory = document.querySelector(\"#category\").value;\n  var inputQuery = document.querySelector(\"#query\").value;\n  if (inputQuery === \"\") _newsAPI__WEBPACK_IMPORTED_MODULE_0__[\"topHeadlines\"](selectCountry, selectCategory).then(function (value) {\n    return _renderUI__WEBPACK_IMPORTED_MODULE_1__[\"renderNews\"](value);\n  })[\"catch\"](function (err) {\n    return _newsAPI__WEBPACK_IMPORTED_MODULE_0__[\"checkResponse\"](err);\n  });else _newsAPI__WEBPACK_IMPORTED_MODULE_0__[\"everything\"](inputQuery).then(function (value) {\n    return _renderUI__WEBPACK_IMPORTED_MODULE_1__[\"renderNews\"](value);\n  })[\"catch\"](function (err) {\n    return _newsAPI__WEBPACK_IMPORTED_MODULE_0__[\"checkResponse\"](err);\n  });\n} //На элементы инициализируем скрипты,\n\n\ndocument.addEventListener(\"DOMContentLoaded\", function () {\n  M.AutoInit();\n  _renderUI__WEBPACK_IMPORTED_MODULE_1__[\"setContainer\"]();\n  loadNews();\n}); //Устанавливаем событие на submit формы\n\ndocument.forms[0].addEventListener(\"submit\", function (el) {\n  el.preventDefault();\n  loadNews();\n});\n\n//# sourceURL=webpack:///./app.js?");
